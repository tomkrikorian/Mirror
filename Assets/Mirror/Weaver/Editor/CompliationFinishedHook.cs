    ...
    static CompliationFinishedHook()
    {
        ...
        CompilationPipeline.assemblyCompilationFinished += (assemblyPath, messages) =>
        {
            ...
            if (!buildingForEditor)
            {
                ...
                if (Unity.UNetWeaver.Program.Process(unityEngineCoreModuleDLL, assemblyPath, outputDirectory, new string[1] {assemblyPath}, new string[0], assemblyResolver, Debug.LogWarning, Debug.LogError))
